...
####################################################################################
    ...
    order = [NAME, CONTIGS__FOR_THRESHOLDS, TOTALLENS__FOR_THRESHOLDS, CONTIGS, LARGCONTIG, TOTALLEN, AVGLEN, MEDLEN, REFLEN, ESTREFLEN, GC, REFGC,
    ...
    main_metrics = [CONTIGS, LARGCONTIG, TOTALLEN, AVGLEN, MEDLEN, LARGALIGN, TOTAL_ALIGNED_LEN,
    ...
    quality_dict = {
        Quality.MORE_IS_BETTER:
            [LARGCONTIG, TOTALLEN, TOTALLENS__FOR_THRESHOLDS, TOTALLENS__FOR_1000_THRESHOLD, TOTALLENS__FOR_10000_THRESHOLD,
             ...
             N50, NG50, N75, NG75, NA50, NGA50, NA75, NGA75, EMEANMAX, E50MAX, E75MAX, EAMEANMAX, STRICT_EAMEANMAX, EA5MAX, EA10MAX, EA15MAX, 
             EA20MAX, EA25MAX, EA30MAX, EA35MAX, EA40MAX, EA45MAX, EA50MAX,  STRICT_EA5MAX, STRICT_EA10MAX, STRICT_EA15MAX, STRICT_EA20MAX, 
             STRICT_EA25MAX, STRICT_EA30MAX, STRICT_EA35MAX, STRICT_EA40MAX, STRICT_EA45MAX, STRICT_EA50MAX, EA75MAX, STRICT_EA75MAX, P5K, P10K, 
             P15K, P20K, STRICT_P5K, STRICT_P10K, STRICT_P15K, STRICT_P20K,
